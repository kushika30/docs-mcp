---
id: 35621588022171
title: "How Do I Create a Custom Action for My AI Agent to Take?"
html_url: "https://support.regal.ai/hc/en-us/articles/35621588022171-How-Do-I-Create-a-Custom-Action-for-My-AI-Agent-to-Take"
updated_at: "2025-05-29T15:10:59Z"
---

# How Do I Create a Custom Action for My AI Agent to Take?

Custom Actions allow your AI Agent to interact with both the Regal platform (e.g., profiles, journeys) and external systems by posting structured data to a defined endpoint in the middle of an AI Agent conversation. They’re essential when your agent needs to do more than just talk—like updating profiles, logging activity, validating inputs, or triggering business logic.
...
"field\_value": "{{contact.address.zipcode}}"
...
- **Name:** What you’ll reference in the payload, using handlebar notation like {{variables.product\_preference}}
...
- **AI Variables** using: {{variables.variable\_name}}
- **Contact Attributes** using: {{contact.attribute\_name}}
...
![Screenshot 2025-04-03 at 12.44.01 PM.png](https://support.regal.ai/hc/article_attachments/35622845527067)![Screenshot 2025-04-03 at 12.43.53 PM.png](https://support.regal.ai/hc/article_attachments/35622870775323)![Screenshot 2025-04-03 at 12.45.58 PM.png](https://support.regal.ai/hc/article_attachments/35622870777371)
...
- Invoke validate_phone with the contact's response.  
...
You should only invoke validate_phone two times at most.   
...
**Still not sure how to get started with a custom action?** No worries, reach out and one of our Regal AI Experts will help you.