...
This guide describes how to use Braze as a source for sending your customer profile and event data to Regal, and how to receive Regal reporting webhooks back into Braze.
...
![](https://files.readme.io/94574b6-Actionbased.png "Actionbased.png")
...
![](https://files.readme.io/ee3d4b3-webhook_rawtext.png "webhook_rawtext.png")

![](https://files.readme.io/5350eab-request_header.png "request header.png")

Add the following:

- **endpoint**: <https://events.regalvoice.com/events>
- **header**: the only header you need is "Authorization" and add your Regal API key. *(Email [[email protected]](/cdn-cgi/l/email-protection#2b585e5b5b44595f6b594e4c4a47054244) to get your API key)*
...
If you have any questions about which events are important to send to Regal or how best to set up these canvases, reach out to [[email protected]](/cdn-cgi/l/email-protection#42313732322d303602302725232e6c2b2d)

# DATA OUT

To get Regal reporting events like sms.sent and call.completed into Braze so they can appear on your Braze profiles and be available for use in the Braze segmentation tool, Canvas and Campaigns, you'll use Regal Reporting Webhooks and Braze Data Transformation to automate data flow.
...
![](https://files.readme.io/8f9e448-small-Screen_Shot_2023-05-01_at_5.02.38_PM.png)
...
![](https://files.readme.io/a6400fb-small-Screen_Shot_2023-05-01_at_5.00.00_PM.png)
> ## 📘
>
...
Regal's [Reporting Webhooks guide](https://developer.regal.io/docs/reporting-webhooks#events) includes the complete list of Reporting events that we publish. There you can see definitions of properties and sample payloads as well.
...
>
> Braze does not support phone numbers as an identifier. To use this as an identifier the phone number can be set as a User Alias. To learn more about Braze User Aliases, please refer to this [documentation](https://www.braze.com/docs/user_guide/data_and_analytics/user_data_collection/user_profile_lifecycle/#user-aliases).
>
